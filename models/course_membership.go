...
// CourseMembership course membership
//
// swagger:model CourseMembership
...
// Validate validates this course membership
func (m *CourseMembership) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CourseMembership) validateAvailability(formats strfmt.Registry) error {
...
func (m *CourseMembership) validateBypassCourseAvailabilityUntil(formats strfmt.Registry) error {
...
func (m *CourseMembership) validateCourseID(formats strfmt.Registry) error {
...
var courseMembershipTypeCourseRoleIDPropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		courseMembershipTypeCourseRoleIDPropEnum = append(courseMembershipTypeCourseRoleIDPropEnum, v)
	}
}

const (

	// CourseMembershipCourseRoleIDInstructor captures enum value "Instructor"
	CourseMembershipCourseRoleIDInstructor string = "Instructor"

	// CourseMembershipCourseRoleIDBbFacilitator captures enum value "BbFacilitator"
	CourseMembershipCourseRoleIDBbFacilitator string = "BbFacilitator"

	// CourseMembershipCourseRoleIDTeachingAssistant captures enum value "TeachingAssistant"
	CourseMembershipCourseRoleIDTeachingAssistant string = "TeachingAssistant"

	// CourseMembershipCourseRoleIDCourseBuilder captures enum value "CourseBuilder"
	CourseMembershipCourseRoleIDCourseBuilder string = "CourseBuilder"

	// CourseMembershipCourseRoleIDGrader captures enum value "Grader"
	CourseMembershipCourseRoleIDGrader string = "Grader"

	// CourseMembershipCourseRoleIDStudent captures enum value "Student"
	CourseMembershipCourseRoleIDStudent string = "Student"

	// CourseMembershipCourseRoleIDGuest captures enum value "Guest"
	CourseMembershipCourseRoleIDGuest string = "Guest"
)

// prop value enum
func (m *CourseMembership) validateCourseRoleIDEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, courseMembershipTypeCourseRoleIDPropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *CourseMembership) validateCourseRoleID(formats strfmt.Registry) error {
...
func (m *CourseMembership) validateCreated(formats strfmt.Registry) error {
...
func (m *CourseMembership) validateID(formats strfmt.Registry) error {
...
func (m *CourseMembership) validateLastAccessed(formats strfmt.Registry) error {
...
func (m *CourseMembership) validateModified(formats strfmt.Registry) error {
...
func (m *CourseMembership) validateUser(formats strfmt.Registry) error {
...
func (m *CourseMembership) validateUserID(formats strfmt.Registry) error {
...
func (m *CourseMembership) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *CourseMembership) UnmarshalBinary(b []byte) error {
	var res CourseMembership
